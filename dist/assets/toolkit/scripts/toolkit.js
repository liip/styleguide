...
var _scrollDoc = __webpack_require__(39);
...
var Collapse = function () {
  function Collapse(el, options) {
    ...
    this._triggers = [].concat(_toConsumableArray(document.querySelectorAll('[data-toggle="collapse"][data-target="#' + this._collapse.id + '"]')));
  ...
  _createClass(Collapse, [{
    ...
    value: function show() {
      ...
      if (this._options.hideOnClick) {
        ...
        window.setTimeout(function () {
          document.addEventListener('click', _this4.hide);
        }, 0);
      }
    ...
    value: function hide() {
      ...
      setTimeout(function () {
        _this5._collapse.style.height = null;
      }, 20);
...
var ContactForm = function () {
  function ContactForm(contactForm) {
    ...
    this._topics = [].concat(_toConsumableArray(this._contactForm.querySelectorAll('.contact-form__topic')));
  ...
  _createClass(ContactForm, [{
    ...
    value: function _addEventListeners() {
      ...
      this._topics.forEach(function (topic) {
        topic.addEventListener('click', _this._setTopic.bind(_this));
      });
      this._contactFormMessage.addEventListener('keypress', function () {
        _this._userTyped = true;
      });
...
function updateIcon(el, icon) {
  ...
  var href = use.getAttribute('xlink:href').split('#')[0];
...
var _prismjs = __webpack_require__(27);
...
var _Multiplier = __webpack_require__(8);
...
var _Reel = __webpack_require__(10);
