...
var Collapse = function () {
  function Collapse(el, options) {
    ...
    this._triggers = [].concat(_toConsumableArray(document.querySelectorAll('[data-toggle="collapse"]'))).filter(function (trigger) {
      var target = trigger.dataset && trigger.dataset.target;
      if (target) {
        return _this._collapse.matches(target);
      }
      return false;
    });
  ...
  _createClass(Collapse, [{
    ...
    value: function _addEventListeners() {
      ...
      this._triggers.forEach(function (trigger) {
        trigger.addEventListener('click', _this2.toggle);
      });
    }
  }, {
    ...
    value: function _removeEventListeners() {
      ...
      this._triggers.forEach(function (trigger) {
        trigger.removeEventListener('click', _this3.toggle);
      });
    }
  }, {
    key: '_setHeight',
    value: function _setHeight() {
      ...
      setTimeout(function () {
        _this4._collapse.classList.add('transitioning');
        _this4._collapse.style.transitionDuration = duration + 'ms';
        _this4._collapse.style.height = height + 'px';
      }, 20);
    }
    ...
    value: function show() {
      ...
      if (this._options.hideOnClick) {
        ...
        window.setTimeout(function () {
          document.addEventListener('click', _this5.hide);
        }, 0);
      }
    ...
    value: function hide() {
      ...
      setTimeout(function () {
        _this6._collapse.style.height = null;
      }, 20);
...
var _Multiplier = __webpack_require__(29);
...
var _ContactForm = __webpack_require__(41);
...
_prismjs2.default.plugins.customClass.prefix('prism--');
...
var MEDIUM_MAX_HEIGHT = 160;
var LARGE_MAX_HEIGHT = 240;
...
var Navbar = function () {
  ...
  _createClass(Navbar, [{
    ...
    value: function _handleScroll() {
      ...
      var navbarHeight = Math.max(Math.min(this._maxHeight, this._threshold - scrollY), 60);
...
document.addEventListener('DOMContentLoaded', function () {
  var collapses = [].concat(_toConsumableArray(document.querySelectorAll('.navbar__collapse')));
  collapses.forEach(function (collapse) {
    var navbar = collapse.closest('.navbar');
    new _Collapse2.default(collapse, {
      hideOnClick: true,
      onShow: function onShow() {
...
var _domDelegate = __webpack_require__(33);
...
var _scrollDoc = __webpack_require__(38);
...
var Reel = function () {
  ...
  _createClass(Reel, [{
    ...
    key: '_handleWindowResize',
    value: function _handleWindowResize() {
      (0, _utils.debounce)(this.refresh.bind(this));
    }
  }, {
    key: 'refresh',
...
var _expandingTextareas = __webpack_require__(42);

var _expandingTextareas2 = _interopRequireDefault(_expandingTextareas);
...
var ContactForm = function () {
  function ContactForm(contactForm) {
    ...
    this.collapse = new _Collapse2.default(this._contactFormStepTwo);
    this.expanding = new _expandingTextareas2.default(this._contactFormMessage);
    ...
    value: function _addEventListeners() {
      ...
      this._fields.forEach(function (field) {
        ...
        field.addEventListener('blur', function () {
          var data = _this._fields.reduce(function (counter, field) {
